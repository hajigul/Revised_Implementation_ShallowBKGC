...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="KGs/FB15K", nargs="?",
                        help="Which dataset to use: FB15K, WN18, YAGO3-10")
    ...
    parser.add_argument("--L2reg", type=float, default=.1, nargs="?", help="L2 regularization.")
    ...
    print(f'Dataset being processed: {kg_name}')
